...
namespace Hhz.SysDF.SysModule
{
    ...
    public partial class ActFormTree : Entity<ActFormTree>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(ActFormTree).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new ActFormTree();
        //    entity.FormID = "abc";
        //    entity.FormName = "abc";
        //    entity.Sumarry = "abc";
        //    entity.FormType = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(ActFormTree).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <returns>实体集</returns>
        public static IList<ActFormTree> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
